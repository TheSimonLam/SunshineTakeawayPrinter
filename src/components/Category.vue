<template>
  <div>
    <div class="type-container" @click="toggleShowItems">{{category.name}}</div>
    <div v-if="showItems">
      <div class="item-square-container" @click="addToOrder(item)" v-for="item in category.items" v-bind:key="item.number">
